...
export const CategoryTabs = ({
	...
	return (
		<div className='flex flex-wrap gap-4 md:gap-20 py-4 md:py-8'>
			{categories.map((category, index) => (
				<button
					key={index}
					onClick={() => !disabled && onCategoryChange(category)}
					className={`relative pb-2 md:pb-4 text-[18px] md:text-[24px] font-bold uppercase cursor-pointer transition-colors border-b-2 border-transparent ${
