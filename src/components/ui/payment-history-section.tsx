			...
			<div className='col-start-1 col-end-5 sm:col-start-1 sm:col-end-13 2-5xl:col-start-3! 2-5xl:col-end-11! min-[2280px]:col-start-1! min-[2280px]:col-end-13!'>
				...
				<div className='lg:hidden space-y-4'>
					{paymentHistory.map(row => (
						<div
							key={row.id}
							className='border border-[#BDBDBD] rounded-[13px] overflow-hidden'
						>
									...
									<table className='w-full'>
										<thead>
											<tr className='border-b border-t border-[#BDBDBD] px-8'>
												...
												<th className='text-right px-4 py-4 text-[16px] font-bold text-[#4F4F4F]'>
													{t('columns.endDate')}
												</th>
											</tr>
										</thead>
										<tbody>
											<tr
												key={row.id}
												className='not-last:border-b border-[#BDBDBD]'
											>
												<td className='text-left pl-4 py-4 text-[16px] font-normal text-[#4F4F4F] leading-[22px]'>
													{row.dateStart}
												</td>
												...
												<td className='text-right px-4 py-4 text-[16px] font-normal text-[#4F4F4F] leading-[22px]'>
													{row.endDate || '—'}
												</td>
											</tr>
										</tbody>
